...
-- 2023-02-18,CHelbling,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_CHelbling')
	 Begin 
	  Alter Database [Assignment07DB_CHelbling] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_CHelbling;
	 End
	Create Database Assignment07DB_CHelbling;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_CHelbling;
...
AS
Select top 1000000000 -- Using approach described in Module 6 to find a way to user Order By in the View creation
	p.ProductName
	, InventoryDate = Datename(Month, i.InventoryDate)+ ', '+ Datename(Year, i.InventoryDate)
	, i.[Count]
From vProducts as p
...
Select top 1000000000 -- Using approach described in Module 6 to find a way to user Order By in the View creation
	...
	,CountVsPreviousCountKPI = Case
		...
		When vpc.[Count] < vpc.PreviousMonthCount Then -1
		End
From vProductInventoriesWithPreviousMonthCounts AS vpc
